...
use atvs\models\SisReviews;
use atvs\models\Empresa;
use atvs\models\ContactForm;
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p><?= Yii::$app->params['nameFull'] ?></p>
                                <p><?= Yii::$app->params['nameDescription'] ?>, versão <?= $review->versao . '.' . str_pad($review->lancamento, 2, 0, STR_PAD_LEFT) . '.' . str_pad($review->revisao, 3, 0, STR_PAD_LEFT) ?></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
