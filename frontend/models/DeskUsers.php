...
class DeskUsers extends \yii\db\ActiveRecord {
    ...
    /**
     * Retorna o status atual do usuário desktop
     * @return string
     */
    public static function getDeskUserStatus($status_desk = null) {
        switch ($status_desk) {
            case self::STATUS_INATIVO: $retorno = 'Inativo';
                break;
            case self::STATUS_ATIVO: $retorno = 'Ativo';
                break;
            case self::STATUS_CANCELADO: $retorno = 'Cancelado';
                break;
            default: $retorno = 'Inexistente';
        }
        return $retorno;
    }

    /**
     * Retorna os status do usuário desktop para filtro
     * @return string
     */
    public static function getStatusDesk() {
        return [
