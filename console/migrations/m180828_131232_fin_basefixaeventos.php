...
/**
 * Class m180828_131232_fin_basefixaeventos
 */
class m180828_131232_fin_basefixaeventos extends Migration {

    const TABELA = 'fin_basefixaeventos';
    ...
    public function safeUp() {
        ...
        $this->execute('ALTER TABLE ' . $this::TABELA . ' ADD UNIQUE INDEX `' . $this::TABELA . '_dom-id_evento-id_fin_base_fixa` '
                . '(dominio, id_fin_eventos, id_fin_base_fixa)');
    ...
    public function safeDown() {
        echo "m180828_131232_fin_basefixaeventos cannot be reverted.\n";
