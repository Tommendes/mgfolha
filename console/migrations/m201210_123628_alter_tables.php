...
class m201210_123628_alter_tables extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->execute('ALTER TABLE fin_rubricas CHANGE parcela complementar VARCHAR(3) CHARSET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT "parcela"');
        $this->execute('ALTER TABLE fin_sfuncional DROP COLUMN slug, DROP COLUMN lanca_anuenio, DROP COLUMN lanca_trienio, DROP COLUMN lanca_quinquenio, DROP COLUMN lanca_decenio, DROP COLUMN D_SITUACAO, DROP COLUMN IDFUNCAO, DROP COLUMN N_DESCONTOS, DROP COLUMN N_LIQUIDO, DROP COLUMN GERADO, DROP COLUMN N_MATERNIDADE, DROP COLUMN HOLERITE_ONLINE, DROP COLUMN lanca_salario, DROP COLUMN lanca_funcao, DROP COLUMN n_bruto, DROP COLUMN decimo_aniv, DROP COLUMN previdencia, DROP COLUMN IF EXISTS  d_tempo, DROP COLUMN d_tempofim');
