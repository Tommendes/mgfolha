    ...
    public function safeUp()
    {
        if ($this->getTableExist($this::TABELA_SFUNCIONAL)) {
            ...
            $this->execute('ALTER TABLE ' . $this::TABELA_SFUNCIONAL
                . ' CHANGE parcela complementar VARCHAR(3) CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT "parcela", '
                ...
                . 'ADD COLUMN id_escolaridade VARCHAR(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Escolaridade", '
                . 'ADD COLUMN escolaridaderais VARCHAR(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Escolaridade RAIS", '
                ...
                . 'ADD COLUMN id_vinculo VARCHAR(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Vínculo", '
                . 'ADD COLUMN id_cat_sefip INT(11) DEFAULT NULL COMMENT "Categoria SEFIP", '
                . 'ADD COLUMN ocorrencia VARCHAR(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Ocorrência", '
                . 'ADD COLUMN carga_horaria DECIMAL(15, 2) DEFAULT NULL COMMENT "Carga horária", '
                . 'ADD COLUMN molestia VARCHAR(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Moléstia", '
                . 'ADD COLUMN d_laudomolestia VARCHAR(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Moléstia data", '
                . 'ADD COLUMN manad_tiponomeacao VARCHAR(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Tipo nomeação", '
                . 'ADD COLUMN manad_numeronomeacao VARCHAR(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Número nomeação", '
                . 'ADD COLUMN d_admissao VARCHAR(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT "Admissão data", '
                . 'ADD COLUMN d_tempo VARCHAR(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL, '
