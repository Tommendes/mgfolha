...
MySQL - 10.4.13-MariaDB : Database - mgfolha_cacimbinhasantigo
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mgfolha_cacimbinhasantigo` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `mgfolha_cacimbinhasantigo`;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getCodAfastamento`(v VARCHAR(2)) RETURNS varchar(500) CHARSET latin1
    DETERMINISTIC
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getDFPcc`(v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getDiasPagarVctoBasico`(ics INT(11),ano_f CHAR(4),mes_f CHAR(2)) RETURNS varchar(255) CHARSET latin1
    DETERMINISTIC
BEGIN
    DECLARE dias
    , dias_p INT(2);
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getEventoSistema`(v_dominio VARCHAR(255),v_evento TEXT, 
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getFinEventosPercentual`(v_dominio varchar(255), v_id_fin_eventos int) RETURNS decimal(11,2)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getFinRubricaPrazo`(prazo int, prazot int) RETURNS int(11)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getFinRubricaPrazoT`(prazo int, prazot int) RETURNS int(11)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getFinRubricasEvtValor`(v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3),v_id_fin_eventos INT,v_id_cad_servidores INT) RETURNS decimal(11,2)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getIdEvento`(v_dominio varchar(255), v_id_evento char(4)) RETURNS int(11)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getIdVinculo`(v_dominio VARCHAR(255),v_id_vinculo INT) RETURNS int(11)
    DETERMINISTIC
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getLiquidos`(v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3),v_id_cad_servidores INT) RETURNS double(11,2)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getMargemConsignavel`(v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3), v_id_cad_servidores INT) RETURNS decimal(11,2)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getParametroAtual`(idUser int) RETURNS int(11)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getSFalecimento`(v_id_cad_servidores INT) RETURNS int(11)
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `getUseOfIdEvento`(v_dominio varchar(255), v_id_fin_eventos char(4)) RETURNS int(11)
    COMMENT 'Retorna o id_fin_evento'
BEGIN
	declare r_quant int;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `fin_folha_descontos`(v_id_user VARCHAR(255),v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `fin_folha_eventos`(v_id_user INT(11), v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3), v_id_cad_servidores INT)
BEGIN 
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `fin_folha_eventos_basico`(v_id_user VARCHAR(255),v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),
v_parcela VARCHAR(3),v_id_cad_servidor VARCHAR(255))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `fin_folha_eventos_consignados`(v_id_user INT(11),v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3), v_id_cad_servidores INT)
BEGIN
	DECLARE done INT DEFAULT FALSE;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `fin_folha_eventos_enios`(v_id_user INT(11),v_dominio VARCHAR(255),v_ano VARCHAR(4),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `fin_folha_eventos_parcelados`(v_id_user INT(11),v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3), v_id_cad_servidores INT)
BEGIN
	DECLARE done INT DEFAULT FALSE;
	DECLARE r_id_fin_rubricas,r_id_cad_servidores,r_id_fin_eventos,r_prazo,r_prazot,r_id_evento INT(11);
	DECLARE r_slug,r_referencia,r_valor_base,r_valor,r_valor_patronal,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `fin_folha_eventos_recorrentes`(v_id_user INT(11),v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3), v_id_cad_servidores INT)
BEGIN
	DECLARE done INT DEFAULT FALSE;
	DECLARE r_id_fin_rubricas,r_id_cad_servidores,r_id_fin_eventos,r_prazo,r_prazot,r_id_evento INT(11);
	DECLARE r_slug,r_referencia,r_valor_base,r_valor,r_valor_patronal,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_eventos_base`(v_dominio varchar(255), v_id_fin_evento int)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_eventos_desconto`(v_dominio varchar(255), v_id_fin_evento int)
    COMMENT 'Retorna a base de calculo de um evento'
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_eventos_percentual`(v_dominio VARCHAR(255), v_id_fin_evento INT)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_fin_faixa`(v_id_user varchar(11), v_tipo char(1))
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_holerites`(v_url_root varchar(255), v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3),v_id_cad_servidores INT,v_id_cad_servidoresF INT)
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_tempo_carteira`(in v_dominio VARCHAR(255),IN v_ano VARCHAR(4),IN v_mes VARCHAR(2),IN v_parcela VARCHAR(3),IN v_id_cad_servidor INT,
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `get_vcto_basico`(v_dominio VARCHAR(255),v_ano VARCHAR(4),v_mes VARCHAR(2),
v_parcela VARCHAR(3),v_id_cad_servidor VARCHAR(255))
BEGIN
