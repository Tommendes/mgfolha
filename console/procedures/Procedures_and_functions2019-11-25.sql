...
/* Procedure structure for procedure `fin_folha_margem_consignavel` */

/*!50003 DROP PROCEDURE IF EXISTS  `fin_folha_margem_consignavel` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `fin_folha_margem_consignavel`(v_ano VARCHAR(4),v_mes VARCHAR(2),v_parcela VARCHAR(3), v_id_cad_servidores INT)
    DETERMINISTIC
    COMMENT 'Retorna a margem consignável do servidor referente a um determinado período'
BEGIN
	DECLARE r_valor, r_margemC, r_margemD, r_consignadoPos, r_margemFinal FLOAT(11,2);
