...
<div class="cad-cargos-form">
    ...
    <div class="row"> 
        <div class="col-md-2">
            <?= $form->field($model, 'id_cargo')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('id_cargo')]) ?>
        </div>
        ...
        <div class="col-md-2">
            <?= $form->field($model, 'cbo')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('cbo')]) ?>
        </div>
