...
/* @var $searchModel pagamentos\models\CadBconveniosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = CadBconveniosController::CLASS_VERB_NAME_PL;
        ...
        'buttons' => [
            'view' => function ($url, $model) {
                return Yii::$app->user->identity->cadastros < 1 ? '' : Html::button('<span class="fa fa-eye"></span> ', [
                            ...
                            'title' => Yii::t('yii', 'See {modelClass}', ['modelClass' => CadBconveniosController::CLASS_VERB_NAME]),
            ...
            'update' => function ($url, $model) {
                return Yii::$app->user->identity->cadastros < 3 ? '' : Html::button('<span class="fa fa-pen-square"></span> ', [
                            ...
                            'title' => Yii::t('yii', 'Updating {modelClass}', ['modelClass' => CadBconveniosController::CLASS_VERB_NAME]),
                            'class' => 'showModalButton button-as-link',
                ]);
            },
...
//            return ArrayHelper::map(CadBconvenios::findAll(), $from, $to);
        },
    ...
    $columns[] = [
        ...
        'format' => 'raw',
        'value' => function($model) {
            $ua = common\models\OrgaoUa::findOne($model->id_orgao_ua);
            if (!$ua == null) {
                $retorno = $ua->nome;
            } else {
    ...
    $buttonCreate = Yii::$app->user->identity->cadastros < 2 ? '' : Html::button(Yii::t('yii', 'Create {modelClass}', [
                        'modelClass' => strtolower(Html::encode(CadBconveniosController::CLASS_VERB_NAME))
                    ]), [
