...
<div class="cad-cidades-form">
    ...
    <div class="row"> 
        <div class="col-md-3">
            <?= $form->field($model, 'uf_nome')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('uf_nome')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'uf_id')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('uf_id')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'uf_abrev')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('uf_abrev')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'municipio_id')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('municipio_id')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'municipio_nome')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('municipio_nome')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'data_registro')->textInput(['placeholder' => $model->getAttributeLabel('data_registro')]) ?>
        </div>
