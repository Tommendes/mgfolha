...
<div class="fin-basefixarefer-form">
    ...
    <div class="row"> 
        <div class="col-md-3">
            <?= $form->field($model, 'id_fin_base_fixa')->textInput(['placeholder' => $model->getAttributeLabel('id_fin_base_fixa')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'id_fixa')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('id_fixa')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'descricao')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('descricao')]) ?>
        </div>
        ...
        <div class="col-md-3">
            <?= $form->field($model, 'valor')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('valor')]) ?>
        </div>
