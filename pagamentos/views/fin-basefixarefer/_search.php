...
/* @var $model pagamentos\models\FinBasefixareferSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="fin-basefixarefer-search">
    ...
    <?php // echo $form->field($model, 'id_fin_base_fixa') ?>

    <?php // echo $form->field($model, 'id_fixa') ?>
