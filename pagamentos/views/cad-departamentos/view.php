...
$this->title = CadDepartamentosController::CLASS_VERB_NAME;
$this->params['breadcrumbs'][] = ['label' => CadDepartamentosController::CLASS_VERB_NAME_PL, 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="cad-departamentos-view">

    <?php
    $label_statusCancelado = Html::icon('warning-sign') . ' ' . ($model->status == pagamentos\models\CadDepartamentos::STATUS_CANCELADO ? 'Registro cancelado >>> Não pode ser editado' : '');
    $buttons = true;
    $attributes[] = [
    ...
    DetailView::widget([
        ...
        'condensed' => false,
        'hover' => true,
        'mode' => !isset(Yii::$app->request->queryParams['mv']) || CadDepartamentos::STATUS_CANCELADO === $model->status ? DetailView::MODE_VIEW : Yii::$app->request->queryParams['mv'],
        ...
        'panel' => [
            'heading' => CadDepartamentosController::CLASS_VERB_NAME,
