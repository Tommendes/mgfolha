...
<div class="cad-departamentos-form">
    ...
    <div class="row"> 
        <div class="col-md-3">
            <?= $form->field($model, 'id_departamento')->textInput(['placeholder' => $model->getAttributeLabel('id_departamento')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'departamento')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('departamento')]) ?>
        </div>
