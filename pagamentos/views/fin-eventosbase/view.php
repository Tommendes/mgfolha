...
$this->title = FinEventosbaseController::CLASS_VERB_NAME;
$this->params['breadcrumbs'][] = ['label' => FinEventosbaseController::CLASS_VERB_NAME_PL, 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="fin-eventosbase-view">
    ...
    <?php
    $label_statusCancelado = Html::icon('warning-sign') . ' ' . ($model->status == pagamentos\models\FinEventosbase::STATUS_CANCELADO ? 'Registro cancelado >>> Não pode ser editado' : '');
    $buttons = true;
    $attributes[] = [
        'columns' => [
            [
            ...
            [
                ...
                'format' => 'raw',
                'value' => $model->id_fin_eventosbase,
                'options' => ['readonly' => !$buttons],
                'displayOnly' => !$buttons,
                'valueColOptions' => ['style' => 'vertical-align: middle;']
            ]
    ...
    DetailView::widget([
        ...
        'condensed' => false,
        'hover' => true,
        'mode' => !isset(Yii::$app->request->queryParams['mv']) || FinEventosbase::STATUS_CANCELADO === $model->status ? DetailView::MODE_VIEW : Yii::$app->request->queryParams['mv'],
        ...
        'panel' => [
            'heading' => FinEventosbaseController::CLASS_VERB_NAME . (Yii::$app->user->identity->administrador >= 2 ? (' ID: (' . $model->id . ')') : ''),
