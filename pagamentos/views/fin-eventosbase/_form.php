...
<div class="fin-eventosbase-form">
    ...
    <div class="row"> 
        <div class="offset-md-4 col-md-2">
            <?= $form->field($model, 'id_fin_eventos')->textInput(['maxlength' => 3, 'placeholder' => $model->getAttributeLabel('id_evento')]) ?>
        </div>

        <div class="col-md-2">
            <?php // echo  $form->field($model, 'id_fin_eventosbase')->dropDownList(Listas::getSNs(), ['prompt' => 'Selecione...']) ?>
            <?= $form->field($model, 'id_fin_eventosbase')->textInput(['maxlength' => 3, 'placeholder' => $model->getAttributeLabel('id_evento')]) ?>
        </div>
    </div>
