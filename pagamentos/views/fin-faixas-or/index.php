...
//                    },
    ...
    if (!(isset(Yii::$app->request->queryParams['faixa']) && !empty(Yii::$app->request->queryParams['faixa']) &&
            is_numeric(Yii::$app->request->queryParams['faixa']) && Yii::$app->request->queryParams['faixa'] >= 0)) {
        $columns[] = [
            'attribute' => 'tipo',
            'format' => 'raw',
            'filter' => common\models\Listas::getTiposFaixa(),
            'filterInputOptions' => ['class' => 'form-control', 'prompt' => 'Selecione...'],
            'width' => '75px',
//        'contentOptions' => ['text-align: right;'],
            'value' => function ($model) {
                return common\models\Listas::getTipoFaixa($model->tipo);
            }
        ];
    }
    $columns[] = [
