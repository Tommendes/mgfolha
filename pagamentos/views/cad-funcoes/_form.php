...
<div class="cad-funcoes-form">
    ...
    <div class="row"> 
        <div class="col-md-3">
            <?= $form->field($model, 'id_funcao')->textInput(['placeholder' => $model->getAttributeLabel('id_funcao')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'funcao')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('funcao')]) ?>
        </div>
