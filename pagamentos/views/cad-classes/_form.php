...
<div class="cad-classes-form">
    ...
    <div class="row"> 
        ...
        <div class="col-md-3">
            <?= $form->field($model, 'id_classe')->textInput(['placeholder' => $model->getAttributeLabel('id_classe')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'nome_classe')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('nome_classe')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'i_ano_inicial')->textInput(['placeholder' => $model->getAttributeLabel('i_ano_inicial')]) ?>
        </div>

        <div class="col-md-3">
            <?= $form->field($model, 'i_ano_final')->textInput(['placeholder' => $model->getAttributeLabel('i_ano_final')]) ?>
        </div>
