...
<div class="cad-pccs-form">
    ...
    <div class="row"> 
        <div class="col-md-2">
            <?= $form->field($model, 'id_pccs')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('id_pccs')]) ?>
        </div>

        <div class="col-md-5">
            <?= $form->field($model, 'nome_pccs')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('nome_pccs')]) ?>
        </div>

        <div class="col-md-2">
            <?= $form->field($model, 'nivel_pccs')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('nivel_pccs')]) ?>
        </div>
