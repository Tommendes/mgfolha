...
<div class="fin-basefixa-form">
    ...
    <div class="row"> 
        <div class="col-md-3">
            <?= $form->field($model, 'id_fin_base_fixa')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('id_fin_base_fixa')]) ?>
        </div>

        <div class="col-md-6">
            <?= $form->field($model, 'nome_base_fixa')->textInput(['maxlength' => true, 'placeholder' => $model->getAttributeLabel('nome_base_fixa')]) ?>
        </div>
