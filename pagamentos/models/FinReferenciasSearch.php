...
/**
 * FinReferenciasSearch represents the model behind the search form of `pagamentos\models\FinReferencias`.
 */
class FinReferenciasSearch extends FinReferencias {
    ...
    public function rules() {
        return [
            [['id', 'status', 'evento', 'created_at', 'updated_at', 'id_pccs', 'id_classe', 'referencia'], 'integer'],
            [['slug', 'dominio', 'data'], 'safe'],
            [['valor'], 'number'],
        ];
    }
