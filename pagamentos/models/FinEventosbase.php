...
/**
 * This is the model class for table "fin_eventosbase".
 *
 ...
 * @property int $id_fin_eventosbase Codigo evento base
 *
 * @property FinEventos $FinEventos
 * @property FinEventos $FinEventosbase
 */
class FinEventosbase extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['slug', 'dominio', 'created_at', 'updated_at', 'id_fin_eventos', 'id_fin_eventosbase'], 'required'],
            [['status', 'evento', 'created_at', 'updated_at', 'id_fin_eventos', 'id_fin_eventosbase'], 'integer'],
            [['slug', 'dominio'], 'string', 'max' => 255],
            [['slug'], 'unique'],
            [['dominio', 'id_fin_eventos', 'id_fin_eventosbase'], 'unique', 'targetAttribute' => ['dominio', 'id_fin_eventos', 'id_fin_eventosbase']],
            [['id_fin_eventos'], 'exist', 'skipOnError' => true, 'targetClass' => FinEventos::className(), 'targetAttribute' => ['id_fin_eventos' => 'id']],
            [['id_fin_eventosbase'], 'exist', 'skipOnError' => true, 'targetClass' => FinEventos::className(), 'targetAttribute' => ['id_fin_eventosbase' => 'id']],
        ];
    }
    ...
    public function attributeLabels() {
        return [
            ...
            'id_fin_eventos' => Yii::t('yii', 'Evento'),
            'id_fin_eventosbase' => Yii::t('yii', 'Base'),
        ];
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getFinEventosbase() {
        return $this->hasOne(FinEventos::className(), ['id' => 'id_fin_eventosbase']);
    }
     ...
     * @return type
     */
    public function getFinEventoBase() {
        return FinEventos::findOne($this->id_fin_eventosbase);
    }
