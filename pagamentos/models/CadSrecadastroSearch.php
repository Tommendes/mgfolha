...
/**
 * CadSrecadastroSearch represents the model behind the search form of `pagamentos\models\CadSrecadastro`.
 */
class CadSrecadastroSearch extends CadSrecadastro {
    ...
    public function rules() {
        return [
            ...
            [['slug', 'dominio', 'id_user_recadastro'], 'safe'],
        ];
    }
    ...
    public function search($params, $id_cad_servidores) {
        ...
        $query->andFilterWhere(['like', $this::tableName() . '.slug', $this->slug])
                ...
                ->andFilterWhere(['like', $this::tableName() . '.id_user_recadastro', $this->id_user_recadastro]);
