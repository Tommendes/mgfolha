...
/**
 * CadLocaltrabalhoSearch represents the model behind the search form of `pagamentos\models\CadLocaltrabalho`.
 */
class CadLocaltrabalhoSearch extends CadLocaltrabalho {
    ...
    public function rules() {
        return [
            [['id', 'status', 'evento', 'created_at', 'updated_at', 'id_local_trabalho'], 'integer'],
            [['slug', 'dominio', 'nome', 'siope'], 'safe'],
        ];
    }
    ...
    public function search($params) {
        ...
        $query->andFilterWhere(['like', $this::tableName() . '.slug', $this->slug])
                ...
                ->andFilterWhere(['like', $this::tableName() . '.siope', $this->siope]);
