...
/**
 * FinBasefixaSearch represents the model behind the search form of `pagamentos\models\FinBasefixa`.
 */
class FinBasefixaSearch extends FinBasefixa {
    ...
    public function rules() {
        return [
            ...
            [['slug', 'dominio', 'id_fin_base_fixa', 'nome_base_fixa'], 'safe'],
        ];
    }
    ...
    public function search($params) {
        ...
        if (!isset(Yii::$app->request->queryParams['sort'])) {
            $query->orderBy([$this::tableName() . '.id_fin_base_fixa' => SORT_ASC]);
        }
        ...
        $query->andFilterWhere(['like', $this::tableName() . '.slug', $this->slug])
                ...
                ->andFilterWhere(['like', $this::tableName() . '.id_fin_base_fixa', $this->id_fin_base_fixa])
                ->andFilterWhere(['like', $this::tableName() . '.nome_base_fixa', $this->nome_base_fixa]);
