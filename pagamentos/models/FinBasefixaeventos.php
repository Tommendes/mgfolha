...
/**
 * This is the model class for table "fin_basefixaeventos".
 *
 ...
 */
class FinBasefixaeventos extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['slug', 'dominio', 'created_at', 'updated_at', 'id_fin_eventos', 'id_fin_base_fixa'], 'required'],
            [['status', 'evento', 'created_at', 'updated_at', 'id_fin_eventos', 'id_fin_base_fixa'], 'integer'],
            [['slug', 'dominio'], 'string', 'max' => 255],
            [['slug'], 'unique'],
            [['dominio', 'id_fin_eventos', 'id_fin_base_fixa'], 'unique', 'targetAttribute' => ['dominio', 'id_fin_eventos', 'id_fin_base_fixa']],
