...
/**
 * CadCargosSearch represents the model behind the search form of `pagamentos\models\CadCargos`.
 */
class CadCargosSearch extends CadCargos {
    ...
    public function rules() {
        return [
            ...
            [['slug', 'dominio', 'id_cargo', 'nome', 'cbo'], 'safe'],
        ];
    }
    ...
    public function search($params) {
        ...
        $query->andFilterWhere(['like', $this::tableName() . '.slug', $this->slug])
                ...
                ->andFilterWhere(['like', $this::tableName() . '.id_cargo', $this->id_cargo])
                ->andFilterWhere(['like', $this::tableName() . '.nome', $this->nome])
                ->andFilterWhere(['like', $this::tableName() . '.cbo', $this->cbo]);
