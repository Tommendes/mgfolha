            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'allow' => true,
                        'matchCallback' => function () {
                            return !Yii::$app->user->isGuest && ($this->cadsferias >= 2 || $this->gestor >= 1);
                        }
                    ],
                    [
                        'actions' => ['u'],
                        'allow' => true,
                        'matchCallback' => function () {
                            return !Yii::$app->user->isGuest && ($this->cadsferias >= 3 || $this->gestor >= 1);
                        }
                    ],
                    [
                        'actions' => ['dlt'],
                        'allow' => true,
                        'matchCallback' => function () {
                            return !Yii::$app->user->isGuest && ($this->cadsferias >= 4 || $this->gestor >= 1);
                        }
                    ],
                ],
            ],
...
//          registra evento no log do sistema
    ...
    /**
     * Creates a new CadSferias model.
...
//          gera evento para ser gravado no log do sistema 
    ...
    /**
     * Updates an existing CadSferias model.
...
//        }
    ...
    /**
     * Deletes an existing CadSferias model.
...
//        $this->findModel($id)->delete();
        ...
        $model->status = CadSferias::STATUS_CANCELADO;
...
//          registra evento no log do sistema
    ...
    /**
     * Duplicates an existing CadSferias model.
    ...
    public function actionDpl($id) {
        $model = $this->findModel($id);
        $id_n = CadSferias::find()->max('id') + 1;
        $model->id = $id_n;
        $model->status = CadSferias::STATUS_ATIVO;
