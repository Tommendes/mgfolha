...
$segurança = <<< HTML
        ...
        <p>Um gravador de sis_events armazena em tempo real cada operação feita no seu banco de informações. Sempre que alguém acessar uma informação ou clicar num botão o LynkOs irá registrar essa operação.</p>
...
$empresa = <<< HTML
        ...
        <p><em>Para maiores informações sobre como utilizamos seus dados, leia nossa <a href="https://mgfolha.com.br/cash/suporte/artigos/politica-privacidade" target="_blank">"Política de privacidade"</a></em></p>        
...
$items = [
    [
        'url' => '#a-1',
        'label' => 'Conteúdo',
        'header' => 'O ' . Yii::$app->params['application-name'],
