    ...
    public function actionIndex($id_cad_servidores = null, $modal = false) {
        if (!is_null($id_cad_servidores)):
            ...
            if (Yii::$app->request->isAjax) {
                return $this->renderAjax('@pagamentos/views/cad-scertidao/index', [
                ...
                return $this->render('@pagamentos/views/cad-scertidao/index', [
                            'searchModel' => $searchModel,
                            'dataProvider' => $dataProvider,
                            'id_cad_servidores' => $id_cad_servidores,
                            'modal' => $modal,
...
//          registra evento no log do sistema
            ...
            if (Yii::$app->request->isAjax) {
                return $this->renderAjax('@pagamentos/views/cad-scertidao/view', [
                            'model' => $model,
                            'modal' => $modal,
                ]);
            } else {
                return $this->render('@pagamentos/views/cad-scertidao/view', [
                            'model' => $model,
                            'modal' => $modal,
                ]);
            }
...
//          gera evento para ser gravado no log do sistema 
                ...
                return $this->redirect(['@pagamentos/views/cad-scertidao/view', 'id' => $model->slug, 'sfm' => false]);
            }
            if (Yii::$app->request->isAjax) {
                return $this->renderAjax('@pagamentos/views/cad-scertidao/_form', [
                            'model' => $model,
                            'modal' => $modal,
                            'id_cad_servidores' => $id_cad_servidores,
                ]);
            } else {
                return $this->render('@pagamentos/views/cad-scertidao/create', [
                            'model' => $model,
                            'modal' => $modal,
                            'id_cad_servidores' => $id_cad_servidores,
                ]);
...
//          registra evento no log do sistema
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return $this->render('@pagamentos/views/cad-scertidao/update', [
                        'model' => $model,
                        'modal' => $modal,
            ]);
        }
...
//          registra evento no log do sistema
        ...
        if (!Yii::$app->request->isAjax) {
            ...
            return $this->redirect(['@pagamentos/views/cad-scertidao/index']);
        } else {
            Yii::$app->response->format = Response::FORMAT_JSON;
            return $data;
        }
    ...
    public function actionDpl($id) {
        ...
        if ($model->save()) {
            ...
            return $this->redirect(['@pagamentos/views/cad-scertidao/view', 'id' => $model->slug]);
        } else {
            Yii::$app->session->setFlash('warning', Yii::t('yii', 'Attempt to duplicate unsuccessful. Error: ') . Json::encode($model->getErrors()));
            return $this->redirect(['@pagamentos/views/cad-scertidao/u', 'id' => $id]);
        }
    }
