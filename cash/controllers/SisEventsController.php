...
class SisEventsController extends Controller {
    ...
    const CLASS_VERB_NAME = 'Evento';
    const CLASS_VERB_NAME_PL = 'SisEvents';
...
//        Yii::$app->response->format = Response::FORMAT_JSON;
    ...
    protected function findModel($id) {
        if (($model = SisEvents::findOne([
                    ...
                    'd ominio' => Yii::$app->user->identity->dominio,
                ])) !== null) {
            return $model;
        }
     ...
     * @return type
     */
    public static function registrarEvento($evento, $classevento, $id_user, $tabela_bd, $id_registro = null, $glt = null, $gln = null) {
//        $return = 0;
