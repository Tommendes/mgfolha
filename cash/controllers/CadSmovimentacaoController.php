    ...
    public function actionIndex($id_cad_servidores = null, $modal = false) {
        if (!is_null($id_cad_servidores)):
            ...
            if (Yii::$app->request->isAjax) {
                return $this->renderAjax('@pagamentos/views/cad-smovimentacao/index', [
                ...
                return $this->render('@pagamentos/views/cad-smovimentacao/index', [
                            'searchModel' => $searchModel,
                            'dataProvider' => $dataProvider,
                            'id_cad_servidores' => $id_cad_servidores,
                            'modal' => $modal,
...
//          registra evento no log do sistema
            ...
            if (Yii::$app->request->isAjax) {
                return $this->renderAjax('@pagamentos/views/cad-smovimentacao/view', [
                            'model' => $model,
                            'modal' => $modal,
                ]);
            } else {
                return $this->render('@pagamentos/views/cad-smovimentacao/view', [
                            'model' => $model,
                            'modal' => $modal,
                ]);
            }
